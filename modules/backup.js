...
// Migriert nur die äußere Backup-Hülle (verschlüsselte appData/cryptoMeta),
// nie deren entschlüsselten Inhalt - der wird erst beim nächsten PIN-Entsperren
// über normalizeAppData() migriert/normalisiert (siehe data/normalization.js).
//
// Eine dritte, frühere Verzweigung für unverschlüsselte Alt-/Fremdformate
// (abweichende Feldnamen wie vorname/nachname, flache patients/verordnungen-
// Arrays) wurde entfernt: sie war seit Einführung der Pflichtprüfung unten
// technisch unerreichbar. validateEncryptedAppData()/validateCryptoMeta()
// (weiter unten in dieser Datei) verlangen zwingend cipherBase64+ivBase64
// bzw. passwordSaltBase64/pinSaltBase64, bevor migrateBackupData() überhaupt
// aufgerufen wird (siehe importBackup()) - eine Datei ohne diese Felder wird
// dort bereits mit einer klaren Fehlermeldung abgelehnt, statt hier still
// (und ggf. unvollständig) migriert zu werden.
